...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Menyimpan data ke dalam tabel dataset
...
<head>
    ...
    <title><?php echo isset($navbar["Add_Data"]) ? $navbar["Add_Data"] : "Add Data"; ?> | FMC - Dashboard</title>
            ...
            <div class="card-body">
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" id="fuel_daily_consumption" name="fuel_daily_consumption" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="opening_fuel_tank_sounding" class="col-md-2 col-form-label">Volume Bahan Bakar Sebelum Perjalanan</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" id="opening_fuel_tank_sounding" name="opening_fuel_tank_sounding" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="closing_fuel_tank_sounding" class="col-md-2 col-form-label">Volume Bahan Bakar Setelah Perjalanan</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" id="closing_fuel_tank_sounding" name="closing_fuel_tank_sounding" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="fuel_tank_stock_after" class="col-md-2 col-form-label">Sisa Stok Bahan Bakar</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" id="fuel_tank_stock_after" name="fuel_tank_stock_after" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
