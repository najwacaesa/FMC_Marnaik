...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["profilePicture"]["tmp_name"], "upload/" . $namafile)) {
            ...
            $sql = "INSERT INTO user (username, email, password, about_me, profile_picture, peran, nama, tanggal_lahir, alamat) VALUES ('$username', '$email', '$password', '$about', '$target_file', '$role', '$nama', '$tanggal_lahir', '$alamat')";
...
<head>
    ...
    <title><?php echo isset($navbar["Admin-List"]) ? $navbar["DasAdmin-Listhboard"] : "Admin List"; ?> | FMC - Dashboard</title>
