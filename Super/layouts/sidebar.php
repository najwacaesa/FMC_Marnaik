...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="admin.php" class="logo logo-dark">
            <span class="logo-sm">
                <img src="assets/images/logo-mobile-sm.png" alt="" height="16"> 
            </span>
            <span class="logo-lg">
                <img src="assets/images/logo-mobile-sm.png" alt="" height="16"> <span class="logo-txt">Dashboard</span>
            </span>
        </a>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="admin-list.php" data-key="t-user-list"><?php echo isset($navbar["Admin-List"]) ? $navbar["Admin-List"] : "Admin List"; ?></a></li>
