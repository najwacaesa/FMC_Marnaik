...
<div id="layout-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card" style="background: linear-gradient( #C40C0C, #F57D1F); border-radius:1rem; box-shadow: 5px 5px 5px #B4B4B8;">
                            <div class="card-body">
                                <div class="text-center py-3">
                                    ...
                                    <div class="main-wid position-relative">
                                        ...
                                        <div class="mt-4 pt-2 mb-2">
                                            <a href="contacts-profile.php" class="btn" style="background-color: black; color:white;">profile <i class="mdi mdi-arrow-right ms-1"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo '<div class="card">';
                            echo '<div class="card-body" style="background-color:#C40C0C; border-radius:1rem; box-shadow: 2px 2px 2px #B4B4B8;">';
    ...
    function selectDestination(destination) {
        ...
        window.location.href = 'admin.php?destination=' + destination;
    }
</script>
