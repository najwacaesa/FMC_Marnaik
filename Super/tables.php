                                ...
                                <div class="card" style="border-radius:1rem; box-shadow: 2px 2px 2px #B4B4B8;">
                                    ...
                                    <div class="card-body">
                                        <div class="grid-container">
                                            ...
                                            <div style="overflow-x:auto; max-height: 393px;">
                                                <?php
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    echo '<th class="table-th">From</th>';
                                                    echo '<th class="table-th">To</th>';
                                                    echo '<th class="table-th">Start ME</th>';
                                                    echo '<th class="table-th">Stop ME</th>';
                                                    echo '<th class="table-th">Running Minutes</th>';
                                                    echo '<th class="table-th">Fuel Daily Consumption</th>';
                                                    echo '<th class="table-th">Opening Fuel Tank Sounding</th>';
                                                    echo '<th class="table-th">Closing Fuel Tank Sounding</th>';
                                                    echo '<th class="table-th">Fuel Tank Stock After</th>';
                                                    echo '</tr>';
        ...
        <script>
            $(document).ready(function() {
                $('#data-table').DataTable({
                    ...
                    "stateSave": true // Mengaktifkan penyimpanan keadaan
                });
