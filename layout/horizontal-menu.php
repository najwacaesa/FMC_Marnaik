                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <i class='bx bx-user'></i>
                                    <span data-key="t-pages"><?php echo isset($translations["Admin"]) ? $navbar["Admin"] : "Admin"; ?></span>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-more">
                                    ...
                                    <a href="../FMC/auth-login.php" class="dropdown-item" data-key="t-vertical"><?php echo isset($navbar["Login"]) ? $navbar["Login"] : "Login"; ?></a>
                                </div>
                            </li>
